;(function ($, window, document, undefined) {
    ...
    var defaults = {
            ...
            cars: [
                "กค-7362 เก๋ง",
                "กค-2690 กระบะ 4 ประตู",
                "นข-1277 รถตู้ 12 ที่นั่ง",
                "นข-1519 รถตู้ 15 ที่นั่ง",
                "40-0067 รถบัส 30 ที่นั่ง",
                "40-0068 รถบัส 45 ที่นั่ง",
                "40-0073 รถบรรทุก 6 ล้อ"
            ],
            onInit: function () {},
    ...
    $.extend(Plugin.prototype, {
        ...
        create: function () {
            ...
            for (var j = 0; j < 7; j++) {
                $("<div class='jqs-grid-line'><div class='jqs-grid-hour'>" + this.settings.cars[j] + "</div></div>")
